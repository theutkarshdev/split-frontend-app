...
const Dashboard = () => {
  return (
    <div>
      ...
      <div className="w-full h-40 bg-slate-200 border rounded-xl squircle p-5">
        Card
      </div>
      ...
      <div className="grid grid-cols-3 gap-2 mt-4">
        {[...Array(9)].map(() => (
          <div className="w-full aspect-square bg-slate-200 rounded-xl squircle grid place-content-center">
            <img
