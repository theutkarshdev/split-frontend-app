...
const Dashboard = () => {
  ...
  return (
    <PageLayout>
      ...
      <CustomCard className="p-5" pClassName="mt-5" radius={20}>
        ...
        <div className="mt-4">
          <div className="grid grid-cols-5 gap-2">
            ...
            >
              <CustomCard radius={13} className="w-full aspect-square p-2">
                <PlusIcon className="size-full text-zinc-200 dark:text-zinc-700" />
              </CustomCard>
            ...
            {loading &&
              [...Array(4)].map((_, idx) => (
                <div key={idx}>
                  <CustomCard radius={13} className="w-full aspect-square">
            ...
            {!loading &&
              !error &&
              profiles.slice(0, 4).map((item, idx) => (
                <div
                  key={idx}
                  className="text-center cursor-pointer"
                  onClick={() => {
